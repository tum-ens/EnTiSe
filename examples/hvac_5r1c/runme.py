"""
Example script HVAC: 5R1C
The code is identical to the jupyter notebook.
This script demonstrates how to use the 5R1C method to generate indoor temperature time series and heating/cooling
...
def analyze_results(summary: pd.DataFrame, df: dict, data: dict, save_figures: bool = False) -> None:
    ...
    def plot_outdoor_temp_with_loads():
        ...
        fig.tight_layout()
        if save_figures:
            plt.savefig(f"building_{building_id}_temp_loads.png", dpi=300)
        plt.show()
