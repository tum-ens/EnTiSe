...
def generate_examples_index():
    ...
    with open(examples_rst_path, 'w') as f:
        ...
        f.write("Examples\n")
        f.write("========\n\n")
        f.write("This section provides examples of how to use EnTiSe for generating timeseries data. Each example demonstrates a\n")
        f.write("different aspect of the library, from basic usage to more complex scenarios. You can find the examples in the\n")
